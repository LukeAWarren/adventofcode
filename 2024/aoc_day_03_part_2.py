...
while len(instructions) > 0:
    ...
    if len(instructions) > 0 and instructions[0] == 'm':
        ...
        if len(instructions) > 0 and instructions[0] == 'u':
            ...
            del instructions[0]
    elif len(instructions) > 0 and instructions[0] == 'd':
        del instructions[0]
        if len(instructions) > 0 and instructions[0] == 'o':
            del instructions[0]
            if len(instructions) > 0 and instructions[0] == 'n':
                del instructions[0]
                if len(instructions) > 0 and instructions[0] == '\'':
                    del instructions[0]
                    if len(instructions) > 0 and instructions[0] == 't':
                        del instructions[0]
                        if len(instructions) > 0 and instructions[0] == '(':
                            del instructions[0]
                            if len(instructions) > 0 and instructions[0] == ')':
                    ...
                    del instructions[0]
            elif len(instructions) > 0 and instructions[0] == '(':
                del instructions[0]
                if len(instructions) > 0 and instructions[0] == ')':
                    del instructions[0]
                    processing = True
